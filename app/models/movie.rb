class Movie < ActiveRecord::Base
  attr_accessible  :file_uri, :imdb_id, :last_modified, :original_title, :overview, :rating, :release_date, :runtime, :sort_title, :tagline, :tmdb_id, :title
  has_many :movie_images, :dependent => :destroy
  has_many :movie_credits, :dependent => :destroy
